(module
 ...
 (data (i32.const 720) "Transfer Award\00")
 (data (i32.const 736) "no balance object found\00")
 (data (i32.const 768) "overdrawn balance\00")
 ...
 (data (i32.const 960) "memo has more than 256 bytes\00")
 (data (i32.const 992) "token with symbol does not exist, create token before issue\00")
 (data (i32.const 1056) "invalid quantity\00")
 (data (i32.const 1088) "must issue positive quantity\00")
 (data (i32.const 1120) "symbol precision mismatch\00")
 (data (i32.const 1152) "quantity exceeds available supply\00")
